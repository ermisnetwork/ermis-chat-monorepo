...
| SDK-006 | Publish both public proprietary packages with npm dist-tag `external` | IN_PROGRESS | Codex | SDK-005 | User selected existing package names/public visibility on 2026-07-18; account has read-write access and release preflight passed |
...
| FE-005 | Build, lint, E2EE smoke test, and clean initial commit | BLOCKED | Codex | FE-004 | Standalone source build/lint pass; registry install, live E2EE smoke, and initial commit pending |
