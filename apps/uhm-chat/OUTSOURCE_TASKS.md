...
| SDK-002 | Remove high-level PIN/epoch archive from core SDK | DONE | Codex | SDK-001 | Source/type negative audit; build evidence pending SDK-005 |
| SDK-003 | Remove PIN/recovery from React SDK | DONE | Codex | SDK-002 | React build passes; final pack evidence pending SDK-005 |
...
| FE-002 | Remove PIN/archive UI and pin exact SDK versions | DONE | Codex | SDK-005 | App build passes against workspace packages |
